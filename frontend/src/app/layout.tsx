...
export const metadata:Metadata={title:{default:'Cedar Construction',template:'%s | Cedar Construction'},description:'Construction operations and thoughtfully engineered residences across Lebanon.'};
